...
To update the database use this command from the Web project folder (replace `ASPPortalMicrosoft` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../ASPPortalMicrosoft.Infrastructure/ASPPortalMicrosoft.Infrastructure.csproj -s ASPPortalMicrosoft.Web.csproj
```
